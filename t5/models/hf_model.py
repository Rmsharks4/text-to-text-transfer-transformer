...
from t5.models.t5_eval_model import T5EvalModel
...
class HfPyTorchModel(T5EvalModel):
...
#
    ...
    if checkpoint_steps is None:
      # TODO(sharanarang): Confirm that this is correct.
    ...
    super(HfPyTorchModel, self).eval(
        mixture_or_task_name,
        eval_model_fn,
        functools.partial(
            get_dataset,
